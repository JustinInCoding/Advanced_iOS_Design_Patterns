...
extension CoinHandler: CoinHandlerProtocol {
	...
	public func createCoin(_ unknownCoin: Coin) -> Coin? {
		print("Attemp to create \(coinType)")
...
let invalidCoin = Coin(diameter: Quarter.standardDiameter, weight: Dime.standardWeight)
